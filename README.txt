...
2. Publish CarRegisterPersonsDatabase and CarRegisterCarsDatabase project to created data bases.
...
4. Rebuild solution.
5. Run in Visual Studio or deploy to IIS CarRegisterAsp.NetMVC5App project.